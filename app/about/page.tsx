        ...
        <main className="flex min-h-screen flex-col bg-gradient-to-b from-[#e8e8e8] to-[#ffffff]">
            ...
            <div className="mt-16 mx-auto p-5 shadow-lg w-screen bg-gradient-to-b from-[#000000] to-[#1c1d1c]">
                ...
                <div className="flex flex-col items-center gap-4 text-lg">
                    ...
                    <p className="md:w-1/2">I became involved in local politics, and concerned about the opportunities in biomedical sciences, particularly regarding the ethical tension of selling pharmaceuticals. I came across a job working for The Green Party in a tech-focussed role, and was successful. I&apos;ve been in that role for 7 years.</p>
                </div>
            </div>
            <Footer />
        </main>
